...
async function loadLibrary() {
    ...
    const upsert = (entry, defaultStatus) => {
        ...
        const baseData = {
            ...
            watchDates,
            watchDate: entry.watchStartDate || watchDates[0] || null,
            watchStartDate: entry.watchStartDate ?? null,
            watchEndDate: entry.watchEndDate ?? null,
    ...
    for (const entry of entries) {
        ...
        if (isWebVideo) {
            enriched.push({
                ...
                watchDate: entry.watchStartDate || orderedWatchDates[0] || null,
                watchStartDate: entry.watchStartDate ?? null,
                watchEndDate: entry.watchEndDate ?? null,
